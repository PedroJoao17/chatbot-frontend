async function fetchBotStatus() {
    try {
        let response = await fetch('https://0516-189-2-84-114.ngrok-free.app/bot-status'); // Endpoint para verificar status do bot
...
async function loadQRCode() {
    try {
        const response = await fetch('https://0516-189-2-84-114.ngrok-free.app/qrcode');  // Endpoint para obter o QR Code
        if (response.ok) {
